...
class FinalResultViewController: UIViewController {
    ...
    @IBOutlet weak var lblRestart: UIButton!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        lblRestart.backgroundColor = .clear
        lblRestart.layer.cornerRadius = 25
        lblRestart.layer.borderWidth = 2
        lblRestart.layer.borderColor = UIColor.init(displayP3Red: 28/255, green: 119/255, blue: 27/255 , alpha: 1.0 ).cgColor
        lblRestart.setTitleColor(UIColor.init(displayP3Red: 28/255, green: 119/255, blue: 27/255 , alpha: 1.0 ), for: .normal)
    }
}
